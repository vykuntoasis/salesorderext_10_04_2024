...
/**
 * Batch builder for operations supported on the Op Api Sales Order Srv 0001.
 * @param requests The requests of the batch
 * @returns A request builder for batch.
 */
export function batch<DeSerializersT extends DeSerializers>(
  ...requests: Array<
    | ReadOpApiSalesOrderSrv0001RequestBuilder<DeSerializersT>
...
export function batch<DeSerializersT extends DeSerializers>(
  ...
  return new ODataBatchRequestBuilder(
    defaultOpApiSalesOrderSrv0001Path,
    transformVariadicArgumentToArray(first, rest)
  );
}

/**
 * Change set constructor consists of write operations supported on the Op Api Sales Order Srv 0001.
 * @param requests The requests of the change set
 * @returns A change set for batch.
 */
export function changeset<DeSerializersT extends DeSerializers>(
  ...requests: Array<WriteOpApiSalesOrderSrv0001RequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT>;
export function changeset<DeSerializersT extends DeSerializers>(
  requests: Array<WriteOpApiSalesOrderSrv0001RequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT>;
export function changeset<DeSerializersT extends DeSerializers>(
  first:
    | undefined
    | WriteOpApiSalesOrderSrv0001RequestBuilder<DeSerializersT>
    | Array<WriteOpApiSalesOrderSrv0001RequestBuilder<DeSerializersT>>,
  ...rest: Array<WriteOpApiSalesOrderSrv0001RequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT> {
  return new BatchChangeSet(transformVariadicArgumentToArray(first, rest));
}

export const defaultOpApiSalesOrderSrv0001Path =
  '/sap/opu/odata/sap/API_SALES_ORDER_SRV';
export type ReadOpApiSalesOrderSrv0001RequestBuilder<
...
> =
  ...
  | GetByKeyRequestBuilder<
      ...
      DeSerializersT
    >;
export type WriteOpApiSalesOrderSrv0001RequestBuilder<
  DeSerializersT extends DeSerializers
> =

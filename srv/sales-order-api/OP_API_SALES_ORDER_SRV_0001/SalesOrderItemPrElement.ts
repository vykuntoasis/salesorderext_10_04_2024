 ...
 */
export class SalesOrderItemPrElement<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements SalesOrderItemPrElementType<T>
{
  /**
   * Technical entity name for SalesOrderItemPrElement.
   */
  static _entityName = 'A_SalesOrderItemPrElement';
  /**
...
export interface SalesOrderItemPrElementType<
  T extends DeSerializers = DefaultDeSerializers
> {

...
export class SalesOrderItemPartnerAddressApi<
    ...
    EntityApi<SalesOrderItemPartnerAddress<DeSerializersT>, DeSerializersT>
{
  ...
  entityConstructor = SalesOrderItemPartnerAddress;

  requestBuilder(): SalesOrderItemPartnerAddressRequestBuilder<DeSerializersT> {
    return new SalesOrderItemPartnerAddressRequestBuilder<DeSerializersT>(this);
  }
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         * All fields selector.
         */
        ALL_FIELDS: new AllFields('*', SalesOrderItemPartnerAddress)
      };
    }
